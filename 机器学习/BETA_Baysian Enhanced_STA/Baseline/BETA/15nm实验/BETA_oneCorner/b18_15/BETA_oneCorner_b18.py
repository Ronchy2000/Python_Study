...
#--------------------------------------------------------------
    ...
    dff.to_csv("b18_15nm_v1_covariance.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v1_prediction.csv", sep=',', index=False)
    print("==================================================================")
...
####------------------------------------------------------------------------------------
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b18_15nm_v2_covariance.csv",sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v2_prediction.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
...
####------------------------------------------------------------------------------------
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b18_15nm_v3_covariance.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v3_prediction.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
...
# #####b18_4
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b18_15nm_v4_covariance.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v4_prediction.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
...
# #####b17_5
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b18_15nm_v5_covariance.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v5_prediction.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
