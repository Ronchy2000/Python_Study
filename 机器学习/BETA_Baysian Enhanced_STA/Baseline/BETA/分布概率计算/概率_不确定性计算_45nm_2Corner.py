...
df1 = pd.read_csv("../BETA_twoCorner/b17_VTL3_prediction2.csv")
df2 = pd.read_csv("../BETA_twoCorner/b17_VTL3_covariance2.csv")
df3 = pd.read_csv("../BETA_twoCorner/b17_VTL3_real2.csv")
