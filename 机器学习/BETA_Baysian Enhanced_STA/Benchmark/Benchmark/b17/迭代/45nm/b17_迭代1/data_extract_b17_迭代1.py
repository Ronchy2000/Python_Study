...
file1_path = "b17_tt_VTL.log"
file2_path = "b17_ff_VTL.log"
file3_path = "b17_fs_VTL.log"
file4_path = "b17_sf_VTL.log"
file5_path = "b17_ss_VTL.log"
...
if len(start_right) == len(end_right):
    ...
    df.to_excel("b17_VTL1x5.xls", sheet_name='Sheet1', index=True)
    print("=========Done!=========")
else:
    print("error，有end不一致")
    #用cnt删掉不一致的路径
