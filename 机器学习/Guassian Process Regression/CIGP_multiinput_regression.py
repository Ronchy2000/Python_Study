...
# @File    : CIGP_multiinput_regression.py
# @Software: PyCharm
...
if __name__ == "__main__":
    ...
    y = df[['Corner1', 'Corner3','Corner4','Corner5']].values
    ...
    plt.errorbar(xte.sum(1), ypred.reshape(-1).detach(), ypred_var.sqrt().squeeze().detach(), fmt='r-.' ,alpha = 0.2)
