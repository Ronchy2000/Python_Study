# -*- coding: utf-8 -*-
# @Time    : 2022/9/21 10:32
# @Author  : Ronchy_LU
# @Email   : rongqi1949@gmail.com
# @File    : Compare_Corner1_2_3.py
# @Software: PyCharm
...
##MAE
Corner1_result_MAE_plot = [111.30132809817754, 57.90079059731588, 17.273904424443664, 157.32547192624403, 66.36891834766786, 48.83213168636948, 125.82300093776868]
Corner2_result_MAE_plot = [98.01578503469811, 55.049662424799976, 16.55337208986829, 140.08156517100534, 59.38977094958916, 52.51621600648719,114.52690422859027]
Corner3_result_MAE_plot = [76.31960083849353, 64.89200145220647, 16.969483480553198, 161.44262969615414, 63.77078862135144, 54.28026908761689, 116.34388125814507]

##RMSE
Corner1_result_RMSE_plot = np.sqrt( np.array([20960.882955096586, 9982.765240790297, 638.8560937249046, 45542.85606003766, 9154.566199345067, 4739.935828936492, 27793.15565676238]) )
Corner2_result_RMSE_plot =np.sqrt(np.array([18005.63240078954, 9218.374012075514, 557.7368960290847, 36385.6816289802, 7107.374069463624, 4981.291222343434, 23083.026416110777]))
Corner3_result_RMSE_plot = np.sqrt(np.array([10754.56969271128, 9766.493689749592, 607.504448450383, 47205.51471025095, 7381.942028740206, 5129.59672569583, 22406.457173726078]))

#LESS30
Corner1_result_LESS30_plot = np.array([0.1806666666666667, 0.5748, 0.8429333333333332, 0.14961111111111108, 0.3958055555555556, 0.47350000000000003, 0.19407407407407407])*100
Corner2_result_LESS30_plot = np.array([0.23186666666666672, 0.6169333333333333, 0.8822666666666666, 0.18422222222222223, 0.4091111111111111, 0.38902777777777775, 0.19871604938271606])*100
Corner3_result_LESS30_plot = np.array([0.27666666666666667, 0.29, 0.8772222222222222, 0.19837962962962963, 0.30752314814814813, 0.3353009259259259, 0.15925925925925927])*100
