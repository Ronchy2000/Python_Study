...
result_RMSE_plot = []
result_LESS10_plot = []
first_corner, second_corner, third_corner = 1, 2, 3
if __name__ == "__main__":
    ...
    ##'''
    list_result_less10 = []
    data_feature = df_data1[:, [first_corner, second_corner, third_corner]]  # 第 1,2列
    # print(data_feature.shape)
    data_target = np.delete(df_data1, [first_corner, second_corner, third_corner], axis=1)  # del 第 1 列
    ...
    ####'''
    list_result_less10 = []
    data_feature = df_data2[:, [first_corner, second_corner, third_corner]]  # 第 1,2列
    # print(data_feature.shape)
    data_target = np.delete(df_data2, [first_corner, second_corner, third_corner], axis=1)  # del 第 1 列
    # print(data_target.shape)
    for j in data_target.T:  # 对 列 进行迭代
        tmp_mae, tmp_rmse, len_less10 = myMLPRegressor(data_feature, j.reshape(-1, 1))
        MAE.append(tmp_mae)
    ...
    # '''
    list_result_less10 = []
    data_feature = df_data3[:, [first_corner, second_corner, third_corner]]  # 第 1,2列
    # print(data_feature.shape)
    data_target = np.delete(df_data3, [first_corner, second_corner, third_corner], axis=1)  # del 第 1 列
    # print(data_target.shape)
    for j in data_target.T:  # 对 列 进行迭代
        tmp_mae, tmp_rmse, len_less10 = myMLPRegressor(data_feature, j.reshape(-1, 1))
        MAE.append(tmp_mae)
    ...
    # '''
    list_result_less10 = []
    data_feature = df_data4[:, [first_corner, second_corner, third_corner]]  # 第 1,2列
    # print(data_feature.shape)
    data_target = np.delete(df_data4, [first_corner, second_corner, third_corner], axis=1)  # del 第 1 列
    # print(data_target.shape)
    for j in data_target.T:  # 对 列 进行迭代
        tmp_mae, tmp_rmse, len_less10 = myMLPRegressor(data_feature, j.reshape(-1, 1))
        MAE.append(tmp_mae)
    ...
    # #'''
    list_result_less10 = []
    data_feature = df_data5[:, [first_corner, second_corner, third_corner]]  # 第 1,2列
    # print(data_feature.shape)
    data_target = np.delete(df_data5, [first_corner, second_corner, third_corner], axis=1)  # del 第 1 列
    # print(data_target.shape)
    for j in data_target.T:  # 对 列 进行迭代
        tmp_mae, tmp_rmse, len_less10 = myMLPRegressor(data_feature, j.reshape(-1, 1))
        MAE.append(tmp_mae)
    ...
    #'''
    list_result_less10 = []
    data_feature = df_data6[:, [first_corner, second_corner, third_corner]]  # 第 1,2列
    # print(data_feature.shape)
    data_target = np.delete(df_data6, [first_corner, second_corner, third_corner], axis=1)  # del 第 1 列
    # print(data_target.shape)
    for j in data_target.T:  # 对 列 进行迭代
        tmp_mae, tmp_rmse, len_less10 = myMLPRegressor(data_feature, j.reshape(-1, 1))
        MAE.append(tmp_mae)
 ...
 ###
    ...
    list_result_less10 = []
    data_feature = df_data7[:, [first_corner, second_corner, third_corner]]  # 第 1,2列
    # print(data_feature.shape)
    data_target = np.delete(df_data7, [first_corner, second_corner, third_corner], axis=1)  # del 第 1 列
    # print(data_target.shape)
    for j in data_target.T:  # 对 列 进行迭代
        tmp_mae, tmp_rmse, len_less10 = myMLPRegressor(data_feature, j.reshape(-1, 1))
        MAE.append(tmp_mae)
...
two_corner
result_MAE_plot [57.06772679431526, 53.198229665971525, 17.00665503448923, 122.65913017503745, 38.048607856781736, 30.42478531689225, 79.07229049995004]
result_RMSE_plot [5698.161702301267, 9186.974451734635, 560.160754471498, 29315.773455862185, 3106.2319519607895, 2094.2331535344633, 12235.572170748283]
result_LESS10_plot [0.34844444444444445, 0.6515555555555556, 0.8568888888888889, 0.22796296296296295, 0.5585185185185185, 0.6507407407407407, 0.3190123456790123]


three_corner
result_MAE_plot [56.42469554476406, 61.91241558383296, 16.014632455396573, 76.04408546755025, 30.25288819249488, 26.082443922214793, 62.87659349711509]
result_RMSE_plot [5797.1853262380455, 9782.950941728746, 501.415340365743, 11848.534963148282, 2143.073778985824, 1680.9572087108972, 8228.499428624289]
result_LESS10_plot [0.372, 0.5453333333333333, 0.8653333333333333, 0.3175, 0.6619444444444444, 0.7175, 0.39037037037037037]
