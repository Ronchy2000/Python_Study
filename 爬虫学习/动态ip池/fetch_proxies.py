...
def main():
    ...
    # 你的机场订阅链接（支持多个）
    subscriptions = [
        'https://sub0530.wdyserver.com/cgi-bin/get/api/domain/ip/access?token=c1c3b23e23c684ec8fb1a9ea2f24fdb6'
        ,'https://msub.xn--m7r52rosihxm.com/api/v1/client/subscribe?token=99db40778a87f33942462ffc9368bf8d'
        ,'https://needaycloud.xyz/api/v1/client/subscribe?token=4db4fb42bdcb18b33337d3df5108d5cb'
        # 可以添加更多订阅链接
    ]
