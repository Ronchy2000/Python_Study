...
file1_path = "b17_tt_VTL2.log"
file2_path = "b17_ff_VTL2.log"
file3_path = "b17_fs_VTL2.log"
file4_path = "b17_sf_VTL2.log"
file5_path = "b17_ss_VTL2.log"
...
if len(start_right) == len(end_right):
    ...
    df.to_excel("b17_VTL2x5.xls", sheet_name='Sheet1', index=True)
