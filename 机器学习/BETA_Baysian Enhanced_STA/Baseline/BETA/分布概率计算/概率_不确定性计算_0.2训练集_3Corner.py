...
df1 = pd.read_csv("../0.2训练集/BETA_threeCorner/b17_VTL3_prediction3.csv")
df2 = pd.read_csv("../0.2训练集/BETA_threeCorner//b17_VTL3_covariance3.csv")
df3 = pd.read_csv("../0.2训练集/BETA_threeCorner//b17_VTL3_real3.csv")
t0 = 750
