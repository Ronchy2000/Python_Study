...
df1 = pd.read_csv("../0.2训练集/BETA_oneCorner/b17_VTL3_prediction.csv")
df2 = pd.read_csv("../0.2训练集/BETA_oneCorner/b17_VTL3_covariance.csv")
df3 = pd.read_csv("../0.2训练集/BETA_oneCorner/b17_VTL3_real.csv")
t0 = 800
