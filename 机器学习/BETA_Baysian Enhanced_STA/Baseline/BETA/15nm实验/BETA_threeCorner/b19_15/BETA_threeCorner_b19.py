...
test_size = 0.25
values = ['b19_v1', 'b19_v2', 'b19_v3', 'b19_v4', 'b19_v5']
...
####b19_1
    ...
    dff.to_csv("b19_15nm_v1_covariance3.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b19_15nm_v1_prediction3.csv", sep=',', index=False)
    print("==================================================================")
...
####b19_2
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b19_15nm_v2_covariance3.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b19_15nm_v2_prediction3.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
...
####b19_3
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b19_15nm_v3_covariance3.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b19_15nm_v3_prediction3.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
...
####b19_4
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b19_15nm_v4_covariance3.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b19_15nm_v4_prediction3.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
...
####b19_5
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b19_15nm_v5_covariance3.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b19_15nm_v5_prediction3.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
