...
GP_result_MAE_plot = [76.34740829467773,26.090026378631592,16.58118987083435,53,40,123.9825439453125,109.82885932922363]
...
GP_result_RMSE_plot = np.sqrt(np.array([11741.055786132812,1735.0331420898438,608.8122940063477,31130.89794921875,7000,4300,21086.615966796875]))
#plot
# x_ax = range(1, len(Ridge_result_MAE_plot) + 1)
#Ridge
...
GP_result_LESS30_plot = np.array([0.332,0.7646666666666667,0.874, 0.22981770833333334, 0.42, 0.35, 0.18387345679012346])*100
#plot
