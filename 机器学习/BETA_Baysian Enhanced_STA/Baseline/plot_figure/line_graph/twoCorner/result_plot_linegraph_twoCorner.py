...
GP_result_MAE_plot = [26.10738182067871, 30.676011721293133, 15.985563112894695,26.801708857218426, 20.03329086303711, 14.917869567871094,0]
##RMSE
...
GP_result_RMSE_plot = np.sqrt(np.array([2938.4017333984375, 4245.41796875, 692.3756103515625,2975.7457682291665, 2902.247517903646, 1505.702901204427,0]))
#LESS30
...
GP_result_LESS30_plot = np.array([0.736, 0.7733333333333333, 0.8862222222222222, 0.7411111112, 0.8322222222222222, 0.8744444444444445,0])*100
...
plt.figure(1)
plt.title("two dominant Corners")
#plot
