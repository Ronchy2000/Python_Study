...
file1_path = "b17_15_fast5.log"
file2_path = "b17_15_lowtemp5.log"
file3_path = "b17_15_slow5.log"
file4_path = "b17_15_typical5.log"
file5_path = "b17_15_worst5.log"
...
if len(start_right) == len(end_right):
    ...
    df.to_csv("b17_15nm_v5_x5.csv", index=True)
    print("=========Done!=========")
else:
    print("error，有end不一致")
    #用cnt删掉不一致的路径
