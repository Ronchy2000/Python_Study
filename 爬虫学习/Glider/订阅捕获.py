...
if __name__ == '__main__':
    # url = input('url:https://mojie.app/api/v1/client/subscribe?token=fb6abad25de7c2ca71bdade530beb375')
    # url = 'https://mojie.app/api/v1/client/subscribe?token=fb6abad25de7c2ca71bdade530beb375'
    url = 'https://dy.qlyundy.com/api/v1/client/subscribe?token=ed0dc2b11d81b18348cfc0485e95c94d'
    s = SubCapture(url)
    source = s.get_source()
