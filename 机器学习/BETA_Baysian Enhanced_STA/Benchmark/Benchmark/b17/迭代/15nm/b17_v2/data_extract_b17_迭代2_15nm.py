...
file1_path = "b17_15_fast2.log"
file2_path = "b17_15_lowtemp2.log"
file3_path = "b17_15_slow2.log"
file4_path = "b17_15_typical2.log"
file5_path = "b17_15_worst2.log"
...
if len(start_right) == len(end_right):
    ...
    df.to_excel("b17_15nm_v2_x5.xls", sheet_name='Sheet1', index=True)
    print("=========Done!=========")
else:
    print("error，有end不一致")
    #用cnt删掉不一致的路径
