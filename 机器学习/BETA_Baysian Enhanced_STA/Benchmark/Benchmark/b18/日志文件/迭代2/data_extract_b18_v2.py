...
file1_path = "b18_tt_VTL2.log"
file2_path = "b18_ff_VTL2.log"
file3_path = "b18_fs_VTL2.log"
file4_path = "b18_sf_VTL2.log"
file5_path = "b18_ss_VTL2.log"
...
if len(start_right) == len(end_right):
    ...
    df.to_excel("b18_VTL2x5.xls", sheet_name='Sheet1', index=True)
    print("=========Done!=========")
else:
