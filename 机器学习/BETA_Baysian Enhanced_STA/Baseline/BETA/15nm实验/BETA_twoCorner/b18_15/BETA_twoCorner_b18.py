...
if __name__ == "__main__":
    ...
    dff.to_csv("b18_15nm_v1_covariance2.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v2_prediction2.csv", sep=',', index=False)
    print("==================================================================")
...
####b18_2
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b18_15nm_v2__covariance2.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v2_prediction2.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
...
####b18_3
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b18_15nm_v3_covariance2.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v3_prediction2.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
...
####b18_4
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b18_15nm_v4_covariance2.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v4_prediction2.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
...
####b17——5
    ...
    list_result_less10.append(one_LESS10)
    dff = pd.DataFrame(Covariance_pred)
    dff.to_csv("b18_15nm_v5_covariance2.csv", sep=',', index=False)
    dff2 = pd.DataFrame(mean_predict)
    dff2.to_csv("b18_15nm_v5_prediction2.csv", sep=',', index=False)
    print("==================================================================")
    print("pridiction siteration:", len(MAE))  # 13*14 次
    result_mae = sum(MAE) / len(MAE)
    print("MAE", result_mae)
